...
#define MSG_HEADER_TYPE_GET_FILE 0x02
#define MSG_HEADER_TYPE_PUT_FILE 0x03
...
#define MSG_HEADER_CODE_REJECT 0x05
#define MSG_HEADER_CODE_ACCEPT 0x06

#define MSG_HEADER_CODE_FAIL 0x07 //通用错误码
